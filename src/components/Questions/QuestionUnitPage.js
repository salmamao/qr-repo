...
class QuestionUnitPage extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            theme: "", id: "",
            answerValidation: "",
            validateAnswerModalIsOpen: false
        };
    }
    ...
    handleAnswer(id, answer) {
        ...
        validateAnswer(id, answer).then((res) => {
            this.setState({
                    validateAnswerModalIsOpen: true,
    ...
    render() {
        ...
        let {content, theme, id, validateAnswerModalIsOpen, answerValidation} = this.state;
        ...
        return (
            <div id="questions-list" className="question-unit">
                <div className="header-section">
                    <h2>question {params.counter}:<span className="highlight"
                                                        style={{textTransform: 'capitalize'}}> {theme} </span></h2>
                    <h3><em>{content}</em></h3>
                ...
                <ReactModal
                    isOpen={validateAnswerModalIsOpen}
                    style={customModalStyles}
                    contentLabel="Modal"
                    onRequestClose={() => this.setState({validateAnswerModalIsOpen: false})}
