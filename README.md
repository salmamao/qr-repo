...
* `npm run eject` – permet d’éjecter l'application et revenir vers une version où on a l'entière contrôle des fichiers de configuration webpack, babel et ESLint..
